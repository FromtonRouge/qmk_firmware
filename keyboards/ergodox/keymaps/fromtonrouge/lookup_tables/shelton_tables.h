...
const uint16_t PROGMEM g_left_pinky_table[128][MAX_ONE_KEYCODE] =
{
    NO_ENTRY,                               // [0]
    _SET(_O),                               // [1]
    _SET(_U),                               // [2]
