...
cp .build/ergodox_infinity_fromtonrouge.bin "$OLDPWD"/infinity/colemak-jackdaw-azerty-left.bin
make ergodox-infinity-fromtonrouge-dfu-util MASTER=right PROGRAMMER_COLEMAK_ENABLE=yes AZERTY_OS_ENABLE=yes
cp .build/ergodox_infinity_fromtonrouge.bin "$OLDPWD"/infinity/colemak-jackdaw-azerty-right.bin

make ergodox-infinity-fromtonrouge-dfu-util PROGRAMMER_COLEMAK_ENABLE=yes AZERTY_OS_ENABLE=no
cp .build/ergodox_infinity_fromtonrouge.bin "$OLDPWD"/infinity/colemak-jackdaw-qwerty-left.bin
make ergodox-infinity-fromtonrouge-dfu-util MASTER=right PROGRAMMER_COLEMAK_ENABLE=yes AZERTY_OS_ENABLE=no
cp .build/ergodox_infinity_fromtonrouge.bin "$OLDPWD"/infinity/colemak-jackdaw-qwerty-right.bin

make ergodox-infinity-fromtonrouge-dfu-util PROGRAMMER_COLEMAK_ENABLE=no AZERTY_OS_ENABLE=no
cp .build/ergodox_infinity_fromtonrouge.bin "$OLDPWD"/infinity/qwerty-jackdaw-qwerty-left.bin
make ergodox-infinity-fromtonrouge-dfu-util MASTER=right PROGRAMMER_COLEMAK_ENABLE=no AZERTY_OS_ENABLE=no
cp .build/ergodox_infinity_fromtonrouge.bin "$OLDPWD"/infinity/qwerty-jackdaw-qwerty-right.bin
