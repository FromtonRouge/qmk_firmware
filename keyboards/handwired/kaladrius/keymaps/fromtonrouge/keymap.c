...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    ...
    [L_STANDARD] = LAYOUT(
        ...
        _DLR,    _Q,      _W,    _F,    _P,    _G,   _AMP,                   _BSLS,       _J,    _L,    _U,       _Y,    _SCLN, _SLSH, 
        KC_TAB,  _A,      _R,    _S,    _T,    _D,   KC_ESC,                 _HASH,       _H,    _N,    _E,       _I,    _O,    _MINS, 
        CKC_SFT, _Z,      _X,    _C,    _V,    _B,                                        _K,    _M,    _COMM,    _DOT,  _APOS, CKC_SFT, 
        KC_LCTL, KC_LALT, MO(L_FN),                                                                                MO(L_FN), _AT, KC_RCTL,
                                               TG(L_FN),                                  TG(L_FN), 
    ...
    [L_SHIFT_COLEMAK] = LAYOUT(
        ...
        CKC_SFUN,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, FR_UGRV,     CKC_SFUN, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,  CKC_SFUN, FR_COMM, 
        ...
        KC_TRNS,  KC_TRNS, KC_TRNS,                                                                              KC_TRNS,  CKC_SFUN,  KC_TRNS, 
                                                      KC_TRNS,                       KC_TRNS, 
